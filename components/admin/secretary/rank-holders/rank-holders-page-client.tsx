...
import { AdminUsersTable, type AdminUserRow } from "@/components/admin/secretary/rank-holders/admin-users-table";
import { AuditLogTable, type AuditLogRow } from "@/components/admin/secretary/rank-holders/audit-log-table";
import { AddAdminDialog } from "@/components/admin/secretary/rank-holders/add-admin-dialog";
