...
import { RoleBadge } from "@/components/admin/secretary/rank-holders/role-badge";
import { ChangeRoleDialog } from "@/components/admin/secretary/rank-holders/change-role-dialog";
import { DropAdminDialog } from "@/components/admin/secretary/rank-holders/drop-admin-dialog";
                  ...
                  return (
                    <TableRow key={admin.id}>
                      ...
                      <TableCell className="font-mono tabular-nums">
                        <CopyableValue value={admin.memberArmyNo} valueClassName="font-mono tabular-nums">
                          {admin.memberArmyNo}
                        </CopyableValue>
                      </TableCell>
                      <TableCell>{formatRank(admin.memberRank)}</TableCell>
                      <TableCell className="font-medium">
                        <CopyableValue value={admin.memberName} valueClassName="font-medium">
                          {admin.memberName}
                        </CopyableValue>
                      </TableCell>
